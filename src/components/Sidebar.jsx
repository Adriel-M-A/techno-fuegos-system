...
export default function Sidebar() {
  return (
    <aside className="w-60 h-screen flex flex-col px-2 bg-[var(--color-sidebar-bg)] border-r border-outline-variant/40 shrink-0">

      {/* Cabecera del panel (alineada a px-6 para coincidir exactamente con el pl-6 de los botones) */}
      <div className="px-6 pt-7 pb-5 border-b border-outline-variant/40">
