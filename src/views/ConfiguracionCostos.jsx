...
// Vista de Insumos y Recetas
function SubvistaInsumos() {
  return (
    <div className="flex flex-col gap-6 pt-4">
      <Card title="Costos Unitarios de Materiales">
        <div className="grid grid-cols-3 gap-4">
          <Input label="Kg de chapa ($/kg)" placeholder="0.00" type="number" />
          <Input label="Kg de hierro ($/kg)" placeholder="0.00" type="number" />
          <Input label="Hora soldador ($/h)" placeholder="0.00" type="number" />
        </div>
        <Divider className="my-4" />
        <div className="flex justify-end">
          <Button variant="primary">Guardar Materiales</Button>
        </div>
      </Card>
